...
const ArrowDownLeft = createLucideIcon("arrow-down-left", __iconNode$R);
const __iconNode$Q = [
  ["path", { d: "m7 7 10 10", key: "1fmybs" }],
  ["path", { d: "M17 7v10H7", key: "6fjiku" }]
];
const ArrowDownRight = createLucideIcon("arrow-down-right", __iconNode$Q);
const __iconNode$P = [
...
const Power = createLucideIcon("power", __iconNode$l);
const __iconNode$k = [
...
const SlidersVertical = createLucideIcon("sliders-vertical", __iconNode$d);
const __iconNode$c = [
