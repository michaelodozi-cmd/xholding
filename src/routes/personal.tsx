      ...
      <section className="pt-40 pb-20 px-6 md:px-8 bg-[#efede8] text-black flex flex-col items-center justify-center">
        <div className="max-w-[1300px] mx-auto w-full text-center">
          ...
          <p className="text-gray-700 text-[18px] md:text-[20px] max-w-3xl mx-auto mb-16 leading-relaxed">
            Whatever your financial goals, Fidelity Holdings provides the tools to power your growth, from saving in high-yield stablecoins to trading digital assets, or sending money to family globally.
          </p>
      ...
      <section className="py-24 bg-[#3d1a17] text-white">
        <div className="max-w-[1100px] mx-auto px-6 md:px-8 text-center mb-16">
          ...
          <p className="text-white/80 text-[15px] max-w-2xl mx-auto mb-6">
            Open a USD account, shop anywhere with Fidelity Holdings debit cards, and earn instant cashback every time you spend in-app.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="flex flex-col gap-4">
              <div className="bg-[#fcd1ce] p-6 rounded-2xl cursor-pointer shadow-sm relative overflow-hidden">
                ...
                <p className="text-black/80 text-[14px] leading-relaxed">Open a USD account, shop anywhere with Fidelity Holdings debit cards, and earn instant cashback every time you spend in-app.</p>
              </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
              ...
              <p className="text-gray-700 leading-relaxed mb-8">
                "I used to keep my savings in a traditional bank earning almost nothing. Moving to Fidelity Holdings' Growth Plan has been the best financial decision I've made."
              </p>
