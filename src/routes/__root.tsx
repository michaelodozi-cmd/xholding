...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Fidelity Holdings — Institutional Private Wealth Platform" },
      { name: "description", content: "Fidelity Holdings gives you access to institutional-grade investment plans, automated copy trading, and real-time portfolio management — all in one secure platform." },
      { name: "author", content: "Fidelity Holdings" },
      { property: "og:title", content: "Fidelity Holdings" },
      ...
      { name: "twitter:title", content: "Fidelity Holdings" },
